...
namespace SevenCurls.Controllers
{
    public class TreatmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TreatmentID,name,duration,price")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TreatmentID,name,duration,price")] Treatment treatment)
        {
            if (ModelState.IsValid)
            {
